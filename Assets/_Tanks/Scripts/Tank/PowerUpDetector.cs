...
namespace Tanks.Complete
{
    public class PowerUpDetector : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (m_TankShooting == null || m_TankMovement == null || m_TankHealth == null)
            {
                Debug.LogWarning(
                    $"[{nameof(PowerUpDetector)}] Missing required tank components on '{name}'. PowerUps may not work correctly.");
            }
        }
