    ...
    public class PowerUp : MonoBehaviour
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            if (other.gameObject.layer == LayerMask.NameToLayer("Players"))
            {
                ...
                // Note: colliders are often on child objects, so the detector can be on a parent.
                PowerUpDetector m_PowerUpDetector = other.GetComponentInParent<PowerUpDetector>();
